...
const SignUp = () => {
  ...
  return (
    ...
    >
      <div className=" bg-gradient-to-br from-gray-300 via-gray-300  to-teal-700 rounded-lg py-6 px-16  shadow-md border border-gray-200 w-[650px] h-fit sm:h-[600px]">
